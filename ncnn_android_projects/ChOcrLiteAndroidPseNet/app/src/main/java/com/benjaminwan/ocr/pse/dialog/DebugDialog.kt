package com.benjaminwan.ocr.pse.dialog
...
import com.benjaminwan.ocr.pse.R
import com.benjaminwan.ocr.pse.models.dbNetTimeItemView
import com.benjaminwan.ocr.pse.models.debugItemView
import com.benjaminwan.ocr.pse.utils.format
import com.benjaminwan.ocr.pse.utils.hideSoftInput
import com.benjaminwan.ocr.pse.utils.setMarginItemDecoration
...
class DebugDialog : BaseDialog(), View.OnClickListener {
    ...
    private var pseNetTime: Double = 0.0
    ...
    private fun initViews() {
        ...
        debugRV.withModels {
            dbNetTimeItemView {
                id("dbnet time item")
                dbNetTimeStr(pseNetTime.format("#0.00") + "ms")
            }
