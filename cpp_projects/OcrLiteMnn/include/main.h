...
const char *example1Msg = "Example1: %s --models models --det det.mnn --cls cls.mnn --rec rec.mnn --keys keys.txt --image 1.jpg\n";
const char *example2Msg = "Example2: %s -d models -1 det.mnn -2 cls.mnn -3 rec.mnn -4 keys.txt -i 1.jpg -t 4 -p 50 -s 0 -b 0.6 -o 0.3 -u 2.0 -a 1 -A 1\n";
