...
:cmakeParams
echo cmake -G "%~1" -A "%~2" -DOCR_OPENMP=%BUILD_OPENMP% -DOCR_JNI=%BUILD_JNI% -DOCR_CLIB=%BUILD_CLIB% -DOCR_STATIC=%BUILD_STATIC% -DONNXRUNTIME_STATIC=%BUILD_ONNXRUNTIME_STATIC% ..
cmake -G "%~1" -A "%~2" -DOCR_OPENMP=%BUILD_OPENMP% -DOCR_JNI=%BUILD_JNI% -DOCR_CLIB=%BUILD_CLIB% -DOCR_STATIC=%BUILD_STATIC% -DONNXRUNTIME_STATIC=%BUILD_ONNXRUNTIME_STATIC% ..
GOTO:EOF
